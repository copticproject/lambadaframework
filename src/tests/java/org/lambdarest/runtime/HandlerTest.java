package org.lambdarest.runtime;
...
import org.lambdarest.runtime.router.Router;
...
@PrepareForTest({Invocable.class, ResourceMethod.class, Router.class, org.lambdarest.jaxrs.ResourceMethod.class})
public class HandlerTest {
    ...
    private Router getMockRouter(String methodName, Class<?>... parameterTypes) throws NoSuchMethodException {
        ...
        org.lambdarest.jaxrs.ResourceMethod mockResourceMethod = PowerMock.createMock(org.lambdarest.jaxrs.ResourceMethod
                .class);
